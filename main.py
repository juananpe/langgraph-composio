...
questions_prompt = (
    f"Generate exactly 3 specific yes/no research questions about the topic '{topic}' in the domain '{domain}'. "
    f"Respond ONLY with the text of the 3 questions formatted as a numbered list, and NOTHING ELSE."
)
...
print("\n\U0001F916: Here are 3 research questions:")
